package com.team9889.lib.roadrunner.drive;
...
import static com.team9889.lib.roadrunner.drive.DriveConstants.MOTOR_VELO_PID;
...
import static com.team9889.lib.roadrunner.drive.DriveConstants.encoderTicksToInches;
...
//    private DcMotorEx leftFront, leftRear, rightRear, rightFront;
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        follower = new HolonomicPIDVAFollower(TRANSLATIONAL_PID, TRANSLATIONAL_PID, HEADING_PID,
                new Pose2d(2.5, 2.5, Math.toRadians(3.0)), .5);
