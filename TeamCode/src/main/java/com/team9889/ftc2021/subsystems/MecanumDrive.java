...
//      Assume Robot is always facing back wall
    ...
    public Vector2d getPositionRed () {
        double dist0 = (double) Robot.getInstance().bulkDataMaster.getAnalogInputValue(0) * 23 / 370;
        double dist1 = (double) Robot.getInstance().bulkDataMaster.getAnalogInputValue(1) * 16 / 250;
