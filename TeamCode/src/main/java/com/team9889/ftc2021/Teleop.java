...
public class Teleop extends Team9889Linear {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            Robot.getLift().SetAngleAdjust(Lift.angle);

            if (gamepad2.dpad_down) {
                Robot.getLift().SetLiftPos(10, 5);
            } else if (gamepad2.dpad_right) {
                Robot.getLift().SetLiftPos(25, 10);
            }
            ...
            /* Telemetry */
            if (Robot.isRed)
                telemetry.addData("<h2 style=\"color:Red;\">Side</h2>","");
            else
                telemetry.addData("<h2 style=\"color:Aqua;\">Side</h2>", "");
